! function () {
    ...
    function n() {
        window.ga && window.ga.loaded || function (e, t, n) {
            e[n] = e[n] || [], e[n].push({
                "gtm.start": (new Date).getTime(),
                event: "gtm.js"
            });
            t = t.createElement("script");
            t["async"] = !0, t.src = "https://www.googletagmanager.com/gtm.js?id=UA-176178393-1", document.head.appendChild(t)
    ...
    var r = "design_system_cookies_policy",
        ...
        o = "176178393-1",
        a = {
            analytics: ["_ga", "_gid", "_gat_UA-" + i, "_gat_UA-" + o],
    ...
    function u(e, t, n) {
        ...
        var r;
        !1 === t || null === t ? u(r = e) && (document.cookie = r + "=;expires=Thu, 01 Jan 1970 00:00:00 GMT;path=/", document.cookie = r + "=;expires=Thu, 01 Jan 1970 00:00:00 GMT;domain=" + window.location.hostname + ";path=/", document.cookie = r + "=;expires=Thu, 01 Jan 1970 00:00:00 GMT;domain=." + window.location.hostname + ";path=/") : h(e, t, n = void 0 === n ? {
            days: 30
        } : n)
    }
    ...
    function t(e) {
        var t, n = (n = c()) || JSON.parse(JSON.stringify(s));
        for (t in e) n[t] = e[t];
        delete n.essential, n.version = window.GDS_CONSENT_COOKIE_VERSION, h(r, JSON.stringify(n), {
            days: 365
        }), d()
    }
    ...
    function d() {
        var e, t = c();
        for (e in t = !l(t) ? JSON.parse(JSON.stringify(s)) : t) "version" !== e && "essential" !== e && ("analytics" === e && t[e] ? (window["ga-disable-UA-" + i] = !1, window["ga-disable-UA-" + o] = !1, n()) : (window["ga-disable-UA-" + i] = !0, window["ga-disable-UA-" + o] = !0), t[e] || a[e].forEach(function (e) {
            u(e, null)
        }))
    }
    ...
    function h(e, t, n) {
        ! function (e) {
            ...
            var t, n = c();
            for (t in l(n) || (n = s), a)
                if ("-1" !== a[t].indexOf(e)) return f(t, n)
        }(e) || (e = e + "=" + t + "; path=/", (n = void 0 === n ? {} : n).days && ((t = new Date).setTime(t.getTime() + 24 * n.days * 60 * 60 * 1e3), e = e + "; expires=" + t.toGMTString()), "https:" === document.location.protocol && (e += "; Secure"), document.cookie = e)
    }
    ...
    y(function (e, t) {
        (function (e) {
            ...
            }() || (a = Object.defineProperty, s = Object.prototype.hasOwnProperty("__defineGetter__"), u = "Getters & setters cannot be defined on this javascript engine", c = "A property cannot both have accessors and be writable or have a value", Object.defineProperty = function (e, t, n) {
                ...
                "bind" in Function.prototype || Object.defineProperty(Function.prototype, "bind", {
                    value: function (t) {
                        ...
                        if (! function v(e) {
                            ...
                            }(f)) throw new TypeError("Function.prototype.bind called on incompatible " + f);
                        for (var p, h = c.call(arguments, 1), m = e(0, f.length - h.length), y = [], g = 0; g < m; g++) d.call(y, "$" + g);
                        return p = Function("binder", "return function (" + y.join(",") + "){ return binder.apply(this, arguments); }")(function () {
                            if (this instanceof p) {
                                var e = f.apply(this, l.call(h, c.call(arguments)));
                                return n(e) === e ? e : this
                            }
                            return f.apply(t, l.call(h, c.call(arguments)))
                        }), f.prototype && (i.prototype = f.prototype, p.prototype = new i, i.prototype = null), p
                    }
                })
            }.call("object" == typeof window && window || "object" == typeof self && self || "object" == typeof m && m || {})
    }), y(function (e, t) {
        (function (e) {
            ...
            function (e) {
                ...
                "Element" in this && "HTMLElement" in this || (!window.Element || window.HTMLElement ? (window.Element = window.HTMLElement = new Function("return function Element() {}")(), n = (t = document.appendChild(document.createElement("body"))).appendChild(document.createElement("iframe")).contentWindow.document, s = Element.prototype = n.appendChild(n.createElement("*")), u = {}, c = function (e, t) {
                    ...
                    for (; i = t && o[++a];) c(i, t);
                    return e
                }, l = document.getElementsByTagName("*"), r = document.createElement, o = 100, s.attachEvent("onpropertychange", function (e) {
                ...
                }), a() || (document.onreadystatechange = a, i = setInterval(a, 25)), document.createElement = function (e) {
                    e = r(String(e).toLowerCase());
                    return c(e)
                }, document.removeChild(t)) : window.HTMLElement = window.Element)
            }.call("object" == typeof window && window || "object" == typeof self && self || "object" == typeof m && m || {}),
            function (e) {
                var a, s, u, c;
                "defineProperty" in Object && function () {
            ...
            function (o) {
                ...
                function s(e, t) {
                    ...
                    storagecommit: 1,
                    textinput: 1
                }, "undefined" != typeof document && "undefined" != typeof window && (e = window.Event && window.Event.prototype || null, window.Event = Window.prototype.Event = function Event(e, t) {
                    ...
                    a._events || (a._events = {}), a._events[e] || (a._events[e] = function (e) {
                        ...
                        for (e.preventDefault = function () {
                            ...
                            }, e.currentTarget = a, e.relatedTarget = e.fromElement || null, e.target = e.target || e.srcElement || a, e.timeStamp = (new Date).getTime(), e.clientX && (e.pageX = e.clientX + document.documentElement.scrollLeft, e.pageY = e.clientY + document.documentElement.scrollTop); ++i < o && !e.cancelImmediate;) i in r && -1 !== s(n, t = r[i]) && "function" == typeof t && t.call(a, e)
                    ...
                    var e, t = this,
                        n = arguments[0];
                    t._events && t._events[n] && t._events[n].list && -1 !== (e = s(t._events[n].list, arguments[1])) && (t._events[n].list.splice(e, 1), t._events[n].list.length || (t.detachEvent && t.detachEvent("on" + n, t._events[n]), delete t._events[n]))
                    ...
                    var t, n = this,
                        r = e.type;
                    try {
                        e.bubbles || (e.cancelBubble = !0, t = function (e) {
                            e.cancelBubble = !0, (n || window).detachEvent("on" + r, t)
                        }, this.attachEvent("on" + r, t)), this.fireEvent("on" + r, e)
                    } catch (i) {
                        for (e.target = n;
                            "_events" in (e.currentTarget = n) && "function" == typeof n._events[r] && n._events[r].call(n, e), "function" == typeof n["on" + r] && n["on" + r].call(n, e), (n = 9 === n.nodeType ? n.parentWindow : n.parentNode) && !e.cancelBubble;);
                    }
                    return !0
    ...
    //     t({
    //         analytics: !0
    //     }), this.$cookieMessage.setAttribute("hidden", !0), this.revealConfirmationMessage(this.$cookieConfirmationAccept)
    // }, b.prototype.rejectCookies = function () {
    //     t({
    //         analytics: !1
    //     }), this.$cookieMessage.setAttribute("hidden", !0), this.revealConfirmationMessage(this.$cookieConfirmationReject)
    // }, b.prototype.revealConfirmationMessage = function (e) {
    //     e.removeAttribute("hidden"), e.getAttribute("tabindex") || (e.setAttribute("tabindex", "-1"), e.addEventListener("blur", function () {
    ...
    w.prototype.init = function () {
        if (this.$module) {
            ...
            var n, r, i, e, o = document.querySelector(".app-footer"),
                a = document.querySelector(".app-subnav");
            o && a && (r = n = !1, i = 0, (e = new window.IntersectionObserver(function (e) {
                ...
                t && (n = t.isIntersecting), e && (r = e.isIntersecting, i = e.intersectionRatio), r || n ? this.$module.classList.remove("app-back-to-top--fixed") : this.$module.classList.add("app-back-to-top--fixed"), r && 1 === i ? this.$module.classList.add("app-back-to-top--hidden") : this.$module.classList.remove("app-back-to-top--hidden")
            }.bind(this))).observe(o), e.observe(a))
        }
    };
    var x = {
        iframeResizer: y(function (e) {
            ...
            function t(t) {
                ...
                function r() {
                    function e() {
                        return r.constructor === Array ? function () {
                            var e = 0,
                                t = !1;
                    ...
                    if (r && "" + n != "null" && !e()) throw new Error("Unexpected message received from: " + n + " for " + v.iframe.id + ". Message was: " + t.data + ". This error can be disabled by setting the checkOrigin: false option or by providing of array of trusted domains.");
                    return 1
                }
                ...
                function s(n, r) {
                    ...
                    e = function () {
                        var e, t;
                        N("Send Page Info", "pageInfo:" + (e = document.body.getBoundingClientRect(), t = v.iframe.getBoundingClientRect(), JSON.stringify({
                    ...
                    }, t = 32, q[i = r] || (q[i] = setTimeout(function () {
                        q[i] = null, e()
                    }, t))
                }
                ...
                function u(e) {
                    var t = e ? i(v.iframe) : {
                        ...
                        n = {
                            x: Number(v.width) + t.x,
                            y: Number(v.height) + t.y
                        };
                    E(b, "Reposition requested from iFrame (offset x:" + t.x + " y:" + t.y + ")"), window.top !== window.self ? window.parentIFrame ? window.parentIFrame["scrollTo" + (e ? "Offset" : "")](n.x, n.y) : k(b, "Unable to scroll to requested position, window.parentIFrame not found") : (Q = n, o(), E(b, "--"))
                }
                ...
                function c(e) {
                    ...
                    r ? (t = i(r), E(b, "Moving to in page link (#" + n + ") at x: " + t.x + " y: " + t.y), Q = {
                        x: t.x,
                        y: t.y
                    }, o(), E(b, "--")) : window.top !== window.self ? window.parentIFrame ? window.parentIFrame.moveToAnchor(n) : E(b, "In page link #" + n + " not found and window.parentIFrame not found") : E(b, "In page link #" + n + " not found")
                }
                ...
                function d() {
                    switch (D[b] && D[b].firstRun && D[b] && (D[b].firstRun = !1), v.type) {
                        case "close":
                            ...
                            break;
                        case "message":
                            t = a(6), E(b, "MessageCallback passed: {iframe: " + v.iframe.id + ", message: " + t + "}"), l("messageCallback", {
                                iframe: v.iframe,
                ...
                var f, p, h, m, y, g = t.data,
                    v = {},
                    b = null;
                "[iFrameResizerChild]Ready" === g ? function () {
                    for (var e in D) N("iFrame requested init", P(e), document.getElementById(e), e)
                }() : F === ("" + g).substr(0, R) && g.substr(R).split(":")[0] in D ? (y = g.substr(R).split(":"), v = {
                    iframe: D[y[0]] && D[y[0]].iframe,
                    id: y[0],
                    height: y[1],
                    width: y[2],
                    type: y[3]
                }, b = v.id, D[b] && (D[b].loaded = !0), (m = v.type in {
                    "true": 1,
                    "false": 1,
                    undefined: 1
                }) && E(b, "Ignoring init message from meta parent page"), !m && (h = !0, D[p = b] || (h = !1, k(v.type + " No settings for " + p + ". Message was: " + g)), h) && (E(b, "Received: " + g), f = !0, null === v.iframe && (k(b, "IFrame (" + v.id + ") not found"), f = !1), f && r() && d())) : S(b, "Ignored: " + g)
            }
            ...
            function O(e) {
                null === Q && E(e, "Get page position: " + (Q = {
                    x: window.pageXOffset !== h ? window.pageXOffset : document.documentElement.scrollLeft,
                    y: window.pageYOffset !== h ? window.pageYOffset : document.documentElement.scrollTop
                }).x + "," + Q.y)
            }
            ...
            function j(e) {
                E(e.id, "Size reset requested by " + ("init" === e.type ? "host page" : "iFrame")), O(e.id), I(function () {
            ...
            function A(i) {
                function n(e) {
                    ...
                    var r;
                    g || "0" !== i[e] || (g = !0, E(o, "Hidden iFrame detected, creating visibility listener"), (r = c()) && function () {
            ...
            function N(t, n, r, i, e) {
                function o() {
                    var e;
                    r && "contentWindow" in r && null !== r.contentWindow ? (e = D[i] && D[i].targetOrigin, E(i, "[" + t + "] Sending msg to iframe[" + i + "] (" + n + ") targetOrigin: " + e), r.contentWindow.postMessage(F + n, e)) : k(i, "[" + t + "] IFrame(" + i + ") not found")
                }

                function a() {
                    e && D[i] && D[i].warningTimeout && (D[i].msgTimeout = setTimeout(function () {
                        !D[i] || D[i].loaded || s || (s = !0, k(i, "IFrame has not responded within " + D[i].warningTimeout / 1e3 + " seconds. Check iFrameResizer.contentWindow.js has been loaded in iFrame. This message can be ignored if everything is working, or you can set the warningTimeout option to a higher value or zero to suppress this warning."))
                    }, D[i].warningTimeout))
                }
                var s = !1;
                i = i || r.id, D[i] && (o(), a())
            ...
            function o(r, e) {
                function t(n) {
                    var e, t = c();
                    t && (e = t, r.parentNode && new e(function (e) {
                        ...
                        var e, t;
                        N("iFrame.onload", n, r, h, !0), e = D[a] && D[a].firstRun, t = D[a] && D[a].heightCalculationMethod in b, !e && t && j({
                            iframe: r,
                            height: 0,
                            width: 0,
                            type: "init"
                ...
                function n(e) {
                    e = e || {}, D[a] = {
                            firstRun: !0,
                            iframe: r,
                            remoteHost: r.src.split("/").slice(0, 3).join("/")
                        },
                        function (e) {
                        ...
                        }(e), D[a] && (D[a].targetOrigin = !0 === D[a].checkOrigin ? "" === (e = D[a].remoteHost) || "file://" === e ? "*" : e : "*")
                }
                var i, o, a = (i = r.id, "" === i && (r.id = (o = e && e.id || $.id + m++, null !== document.getElementById(o) && (o += m++), i = o), y = (e || {}).log, E(i, "Added missing iframe ID: " + i + " (" + r.src + ")")), i);
                ...
                a in D && "iFrameResizer" in r ? k(a, "Ignored iFrame, already setup.") : (n(e), function () {
                ...
                }(), u("Height"), u("Width"), s("maxHeight"), s("minHeight"), s("maxWidth"), s("minWidth"), "number" != typeof (D[a] && D[a].bodyMargin) && "0" !== (D[a] && D[a].bodyMargin) || (D[a].bodyMarginV1 = D[a].bodyMargin, D[a].bodyMargin = D[a].bodyMargin + "px"), t(P(a)), Function.prototype.bind && D[a] && (D[a].iframe.iFrameResizer = {
            ...
            function s(e) {
                E("window", "Trigger event: " + e), a(function () {
                    d("Window " + e, "resize")
                }, 16)
            }

            function u() {
                "hidden" !== document.visibilityState && (E("document", "Trigger event: Visiblity change"), a(function () {
            ...
            function f() {
                ...
                return function () {
                    ...
                    }(), w(window, "message", t), w(window, "resize", function () {
                        s("resize")
                    }), w(document, "visibilitychange", u), w(document, "-webkit-visibilitychange", u), w(window, "focusin", function () {
                        s("focus")
            ...
            "undefined" != typeof window && (M = "message".length, R = (F = "[iFrameSizer]").length, v = window.requestAnimationFrame, $ = {
                autoResize: !(B = Q = null),
                bodyBackground: null,
                bodyMargin: null,
                bodyMarginV1: 8,
            ...
            }, q = {}, window.jQuery && p(window.jQuery), "function" == typeof h && h.amd ? h([], f) : e.exports = f(), window.iFrameResize = window.iFrameResize || f())
        }),
        iframeResizerContentWindow: y(function (Ie) {
            ! function (l) {
                if ("undefined" != typeof window) {
                    ...
                    var H, V, W, U, G, J, K, Y = Date.now || function () {
                ...
                function ue() {
                    ...
                    var t;
                    t = g.substr(E).split(":"), S = t[0], o = l !== t[1] ? Number(t[1]) : o, u = l !== t[2] ? e(t[2]) : u, w = l !== t[3] ? e(t[3]) : w, b = l !== t[4] ? Number(t[4]) : b, n = l !== t[6] ? e(t[6]) : n, a = t[7], m = l !== t[8] ? t[8] : m, r = t[9], s = t[10], C = l !== t[11] ? Number(t[11]) : C, v.enable = l !== t[12] && e(t[12]), T = l !== t[13] ? t[13] : T, M = l !== t[14] ? t[14] : M, ae("Initialising iFrame (" + location.href + ")"),
                        function () {
                            function e(e, t) {
                            ...
                            "iFrameResizer" in window && Object === window.iFrameResizer.constructor && (function () {
                                ...
                                ae("Reading data from page: " + JSON.stringify(e)), R = "messageCallback" in e ? e.messageCallback : R, Q = "readyCallback" in e ? e.readyCallback : Q, L = "targetOrigin" in e ? e.targetOrigin : L, m = "heightCalculationMethod" in e ? e.heightCalculationMethod : m, M = "widthCalculationMethod" in e ? e.widthCalculationMethod : M
                            }(), m = e(m, "height"), M = e(M, "width"));
                        ...
                        function () {
                        ...
                        }(), ce("background", r), ce("padding", s), (t = document.createElement("div")).style.clear = "both", t.style.display = "block", document.body.appendChild(t), pe(), he(), document.documentElement.style.height = "", document.body.style.height = "", ae('HTML & body height set to "auto"'), ae("Enable public methods"), F.parentIFrame = {
                            ...
                            function t(e) {
                                var t, n = e.split("#")[1] || e,
                                    e = decodeURIComponent(n),
                                    r = document.getElementById(e) || document.getElementsByName(e)[0];
                                l !== r ? (t = i(t = r), ae("Moving to in page link (#" + n + ") at x: " + t.x + " y: " + t.y), Le(t.y, t.x, "scrollToOffset")) : (ae("In page link (#" + n + ") not found in iFrame, so sending to parent"), Le(0, 0, "inPageLink", "#" + n))
                            }
                            ...
                            function r() {
                                Array.prototype.forEach && document.querySelectorAll ? (ae("Setting up location.hash handlers"), n(), ne(window, "hashchange", e), setTimeout(e, d)) : se("In page linking not fully supported in this browser! (See README.md for IE8 workaround)")
                            }
                ...
                function me() {
                    var e;
                    !0 === n ? (de("add"), e = b < 0, window.MutationObserver || window.WebKitMutationObserver ? e ? ge() : t = function () {
                        function t(e) {
                            function t(e) {
                        ...
                        var s = [],
                            ...
                            c = function () {
                                var e = document.querySelector("body");
                                return c = new u(a), ae("Create body MutationObserver"), c.observe(e, {
                                    attributes: !0,
                                    attributeOldValue: !1,
                                    characterData: !0,
                                    characterDataOldValue: !1,
                    ...
                    }() : (ae("MutationObserver not supported in this browser!"), ge())) : ae("Auto Resize disabled")
                }
                ...
                function ve(e, r) {
                    var t = 0;
                    return r = r || document.body, t = "defaultView" in document && "getComputedStyle" in document.defaultView ? null !== (t = document.defaultView.getComputedStyle(r, null)) ? t[e] : 0 : function (e) {
                ...
                function Se(e, t, n, r) {
                    function i() {
                        e in {
                            ...
                            interval: 1,
                            size: 1
                        } || !(m in k || u && M in k) ? e in {
                            interval: 1
                        } || ae("No change in size detected") : Oe(t)
                    }
                    var o, a;
                ...
                function ke(e, t, n, r) {
                    j && e in c ? ae("Trigger event cancelled: " + e) : (e in {
                        reset: 1,
                        resetPage: 1,
                        init: 1
                    } || ae("Trigger event: " + t), ("init" === e ? Se : ee)(e, t, n, r))
                }

                function Te() {
                    j || (j = !0, ae("Trigger event lock on")), clearTimeout(A), A = setTimeout(function () {
                ...
                function Ce(t) {
                    var n = {
                        init: function () {
                            g = t.data, O = t.source, ue(), f = !1, setTimeout(function () {
                                y = !1
                            }, d)
                        },
                        reset: function () {
    ...
    y(function (e, t) {
        (function (e) {
            ...
            function (n) {
                var e, r, i;
                "DOMTokenList" in this && (!("classList" in (e = document.createElement("x"))) || !e.classList.toggle("x", !1) && !e.className) || ("DOMTokenList" in (e = this) && e.DOMTokenList && (!document.createElementNS || !document.createElementNS("http://www.w3.org/2000/svg", "svg") || document.createElementNS("http://www.w3.org/2000/svg", "svg").classList instanceof DOMTokenList) || (e.DOMTokenList = function () {
                    var i = !0,
                        t = function (e, t, n, r) {
                ...
                }()), "classList" in (e = document.createElement("span")) && (e.classList.toggle("x", !1), e.classList.contains("x") && (e.classList.constructor.prototype.toggle = function (e) {
                    var t = arguments[1];
                    if (t !== n) return this[(t = !!t) ? "add" : "remove"](e), t;
                    t = !this.contains(e);
                    return this[t ? "add" : "remove"](e), t
                })), "classList" in (e = document.createElement("span")) && (e.classList.add("a", "b"), e.classList.contains("b") || (r = e.classList.constructor.prototype.add, e.classList.constructor.prototype.add = function () {
                    for (var e = arguments, t = arguments.length, n = 0; n < t; n++) r.call(this, e[n])
                })), "classList" in (e = document.createElement("span")) && (e.classList.add("a"), e.classList.add("b"), e.classList.remove("a", "b"), e.classList.contains("b") && (i = e.classList.constructor.prototype.remove, e.classList.constructor.prototype.remove = function () {
    ...
    function A(e) {
        this.$module = e, this.$allTabContainers = this.$module.querySelectorAll(".js-tabs__container"), this.$allTabTogglers = this.$module.querySelectorAll(j), this.$allTabTogglersMarkedOpen = this.$module.querySelectorAll(".js-tabs__item--open a"), this.$mobileTabs = this.$module.querySelectorAll(".js-tabs__heading a")
    }
    A.prototype.init = function () {
        this.$module && (this.enhanceMobileButtons(this.$mobileTabs), this.resetTabs(), this.$module.addEventListener("click", this.handleClick.bind(this)), S(this.$allTabTogglersMarkedOpen, function (e) {
            e.click()
        }))
        ...
        t && (n ? (t.classList.add(C), t.setAttribute("aria-hidden", "true"), S(e, function (e) {
            e.setAttribute("aria-expanded", "false"), e.parentNode.classList.remove(T, L)
        })) : (this.resetTabs(), t.classList.remove(C), t.setAttribute("aria-hidden", "false"), S(e, function (e) {
        ...
        S(e, function (e) {
            ...
            t.setAttribute("aria-controls", e.getAttribute("aria-controls")), t.setAttribute("data-track", e.getAttribute("data-track")), t.classList.add("app-tabs__heading-button"), t.innerHTML = e.innerHTML, e.parentNode.appendChild(t), e.parentNode.removeChild(e)
            ...
            return r = {}, i.m = n = [function (e, t, n) {
                ...
                i(c, [{
                    ...
                    value: function () {
                        ...
                        this.fakeElem.style.top = t + "px", this.fakeElem.setAttribute("readonly", ""), this.fakeElem.value = this.text, this.container.appendChild(this.fakeElem), this.selectedText = (0, u["default"])(this.fakeElem), this.copyText()
                    }
                }, {
                    key: "removeFake",
                    value: function () {
                ...
                function c(e) {
                    ! function (e, t) {
                        if (!(e instanceof t)) throw new TypeError("Cannot call a class as a function")
                    }(this, c), this.resolveOptions(e), this.initSelection()
                }
                e.exports = i
            }, function (e, t) {
                ...
                e.exports = function (e, t, n) {
                    ...
                    if (c.node(e)) return s = t, u = n, (a = e).addEventListener(s, u), {
                        destroy: function () {
                            a.removeEventListener(s, u)
                        }
                    };
                    if (c.nodeList(e)) return r = e, i = t, o = n, Array.prototype.forEach.call(r, function (e) {
    ...
    D.prototype.bindUIEvents = function () {
        ...
        //     t.classList.contains(M) ? (t.classList.remove(M), t.setAttribute("aria-hidden", "true"), n.classList.remove(F), n.setAttribute("aria-expanded", "false")) : (t.classList.add(M), t.setAttribute("aria-hidden", "false"), n.setAttribute("aria-expanded", "true"), n.classList.add(F))
        // }), t.addEventListener("click", function (e) {
        //     var t, n, r = e.target;
        //     !r.classList.contains("js-mobile-nav-subnav-toggler") || (n = (t = r.parentNode).parentNode.querySelector(".js-app-mobile-nav-subnav")) && (n.classList.contains(R) ? (n.classList.remove(R), t.classList.remove(Q), n.setAttribute("aria-hidden", "true"), r.setAttribute("aria-expanded", "false")) : (n.classList.add(R), t.classList.add(Q), n.setAttribute("aria-hidden", "false"), r.setAttribute("aria-expanded", "true")), e.preventDefault())
        // })
        ...
        // P(e, function (e, t) {
        //     var n, r, i = e.parentNode.parentNode.querySelector(".js-app-mobile-nav-subnav");
        //     i && (n = i.classList.contains(R), r = "js-mobile-nav-subnav-toggler-" + t, i.setAttribute("id", t = "js-mobile-nav__subnav-" + t), i.setAttribute("aria-hidden", n ? "false" : "true"), e.setAttribute("id", r), e.setAttribute("aria-expanded", n ? "true" : "false"), e.setAttribute("aria-controls", t))
        // })
    }, D.prototype.init = function () {
        "querySelector" in document && "addEventListener" in window && (this.addHeadings(), this.includeAria(), this.bindUIEvents())
    };
    var B = e(y(function (e, t) {
            var n;
            window, n = function () {
                return r = {}, i.m = n = [function (e, t, n) {
                    var h = n(1),
                        ...
                        w = function (e, t, n) {
                            var r, i, o, a = e & w.F,
                                ...
                                f = s ? m : m[t] || (m[t] = {}),
                                p = f[b] || (f[b] = {});
                            for (r in n = s ? t : n) i = ((o = !a && d && d[r] !== undefined) ? d : n)[r], o = l && o ? v(i, h) : c && "function" == typeof i ? v(Function.call, i) : i, d && g(d, r, i, e & w.U), f[r] != i && y(f, r, o), c && p[r] != i && (p[r] = i)
                        };
                    ...
                    function r(e, t) {
                        ...
                        for (t && null != t.children && (c.length || c.push(t.children), delete t.children); c.length;)
                            ...
                            else "boolean" == typeof r && (r = null), (i = "function" != typeof e) && (null == r ? r = "" : "number" == typeof r ? r = String(r) : "string" != typeof r && (i = !1)), i && n ? o[o.length - 1] += r : o === l ? o = [r] : o.push(r), n = i;
                        var s = new u;
                    ...
                    function N(e, t, n, r, i) {
                        var o = e,
                            a = C;
                        if ("string" == typeof (t = null == t || "boolean" == typeof t ? "" : t) || "number" == typeof t) return e && e.splitText !== undefined && e.parentNode && (!e._component || i) ? e.nodeValue != t && (e.nodeValue = t) : (o = document.createTextNode(t), e && (e.parentNode && e.parentNode.replaceChild(o, e), P(e, !0))), o.__preactattr_ = !0, o;
                        var s = t.nodeName;
                        if ("function" == typeof s) return function h(e, t, n, r) {
                            ...
                            return i && u && (!r || i._component) ? (F(i, c, 3, n, r), e = i.base) : (o && !s && (Q(o), e = a = null), i = M(t.nodeName, c, n), e && !i.nextBase && (i.nextBase = e, a = null), F(i, c, 1, n, r), e = i.base, a && e !== a && (a._component = null, P(a, !1))), e
                        }(e, t, n, r);
                        if (C = "svg" === s || "foreignObject" !== s && C, s = String(s), (!e || !T(e, s)) && (o = function m(e, t) {
                        ...
                        var i = o.firstChild,
                            ...
                            s = t.children;
                        if (null == u)
                            for (var u = o.__preactattr_ = {}, c = o.attributes, l = c.length; l--;) u[c[l].name] = c[l].value;
                        return !j && s && 1 === s.length && "string" == typeof s[0] && null != i && i.splitText !== undefined && null == i.nextSibling ? i.nodeValue != s[0] && (i.nodeValue = s[0]) : (s && s.length || null != i) && function (e, t, n, r, i) {
                                var o, a, s, u, c, l, d = e.childNodes,
                                    f = [],
                                    p = {},
                                    h = 0,
                                    m = 0,
                                ...
                                if (0 !== v)
                                    for (b = 0; b < v; b++) {
                                        ...
                                        if (null != (S = (E = t[b]).key)) h && p[S] !== undefined && (k = p[S], p[S] = undefined, h--);
                                            ...
                                            for (o = m; o < g; o++)
                                                if (f[o] !== undefined && (u = a = f[o], l = i, "string" == typeof (c = E) || "number" == typeof c ? u.splitText !== undefined : "string" == typeof c.nodeName ? !u._componentConstructor && T(u, c.nodeName) : l || u._componentConstructor === c.nodeName)) {
                                                    k = a, f[o] = undefined, o === g - 1 && g--, o === m && m++;
                                                    break
                                                } k = N(k, E, n, r), s = d[b], k && k !== e && k !== s && (null == s ? e.appendChild(k) : k === s.nextSibling ? _(s) : e.insertBefore(k, s))
                                    }
                                if (h)
                                    for (var b in p) p[b] !== undefined && P(p[b], !1);
                    ...
                    function F(e, t, n, r, i) {
                        e._disable || (e._disable = !0, e.__ref = t.ref, e.__key = t.key, delete t.ref, delete t.key, "undefined" == typeof e.constructor.getDerivedStateFromProps && (!e.base || i ? e.componentWillMount && e.componentWillMount() : e.componentWillReceiveProps && e.componentWillReceiveProps(t, r)), r && r !== e.context && (e.prevContext || (e.prevContext = e.context), e.context = r), e.prevProps || (e.prevProps = e.props), e.props = t, e._disable = !1, 0 !== n && (1 !== n && !1 === E.syncComponentUpdates && e.base ? d(e) : R(e, 1, i)), e.__ref && e.__ref(e))
                    }
                    ...
                    function R(e, t, n, r) {
                        if (!e._disable) {
                            var i, o = e.props,
                                ...
                                m = !1,
                                y = l;
                            if (e.constructor.getDerivedStateFromProps && (a = S(S({}, a), e.constructor.getDerivedStateFromProps(o, a)), e.state = a), d && (e.props = u, e.state = c, e.context = l, 2 !== t && e.shouldComponentUpdate && !1 === e.shouldComponentUpdate(o, a, s) ? m = !0 : e.componentWillUpdate && e.componentWillUpdate(o, a, s), e.props = o, e.state = a, e.context = s), e.prevProps = e.prevState = e.prevContext = e.nextBase = null, e._dirty = !1, !m) {
                                o = e.render(o, a, s), e.getChildContext && (s = S(S({}, s), e.getChildContext())), d && e.getSnapshotBeforeUpdate && (y = e.getSnapshotBeforeUpdate(u, c));
                                var g, v, b, a = o && o.nodeName;
                                if ("function" == typeof a ? (b = k(o), (i = h) && i.constructor === a && b.key == i.__key ? F(i, b, 1, s, !1) : (g = i, e._component = i = M(a, b, s), i.nextBase = i.nextBase || f, i._parentComponent = e, F(i, b, 0, s, !1), R(i, 1, n, !0)), v = i.base) : (b = p, (g = h) && (b = e._component = null), !p && 1 !== t || (b && (b._component = null), v = function I(e, t, n, r, i, o) {
                                        L++ || (C = null != i && i.ownerSVGElement !== undefined, j = null != e && !("__preactattr_" in e));
                                        r = N(e, t, n, r, o);
                                        return i && r.parentNode !== i && i.appendChild(r), --L || (j = !1, o || A()), r
                                    }(b, o, s, n || !d, p && p.parentNode, !0))), !p || v === p || i === h || (h = p.parentNode) && v !== h && (h.replaceChild(v, p), g || (p._component = null, P(p, !1))), g && Q(g), (e.base = v) && !r) {
                    ...
                    o.enhanceSelectElement = function (n) {
                        ...
                        n.source || (e = [].filter.call(n.selectElement.options, function (e) {
                            ...
                            e && (e.selected = !0)
                        }, !n.selectElement.value && n.defaultValue !== undefined || (t = n.selectElement.options[n.selectElement.options.selectedIndex], n.defaultValue = t.textContent || t.innerText), n.name === undefined && (n.name = ""), n.id === undefined && (n.selectElement.id === undefined ? n.id = "" : n.id = n.selectElement.id), n.autoselect === undefined && (n.autoselect = !0);
                        var t = document.createElement("div");
                        n.selectElement.parentNode.insertBefore(t, n.selectElement), o(Object.assign({}, n, {
                            element: t
                    ...
                    var s, u, n = (function r(e, t) {
                        e.prototype = Object.create(t.prototype), (e.prototype.constructor = e).__proto__ = t
                    }(c, s = Q.Component), (u = c.prototype).isQueryAnOption = function (e, t) {
                        var n = this;
                        ...
                        t = r && null === t.focused; - 1 === n && t && (n = this.elementReferences[n]).setSelectionRange(0, n.value.length)
                        ...
                        var t, n = this.state,
                            ...
                            i = n.query,
                            n = n.selected;
                        this.props.confirmOnBlur ? (t = e.query || i, this.props.onConfirm(r[n])) : t = i, this.setState({
                            focused: null,
                        ...
                        var n = this.state,
                            ...
                            r = r !== t && -1 !== r;
                        (!r && n || !r && !e) && (i = i && $(), this.handleComponentBlur({
                            menuOpen: i,
                        ...
                        var t = this.state,
                            ...
                            i = t.options,
                            o = t.query,
                            t = t.selected; - 1 === n && (r = r && $(), t = $() ? o : this.templateInputValue(i[t]), this.handleComponentBlur({
                            menuOpen: r,
                            query: t
                        }))
                        ...
                        var t = this.state,
                            e = t.menuOpen,
                            t = t.selected; - 1 !== t && e && this.handleOptionFocus(t - 1)
                        ...
                        return l && "string" == typeof (e = g({
                            ...
                            tSelectedOption: h,
                            tResults: m
                        }), O && (0, Q.createElement)("span", null, (0, Q.createElement)("input", {
                            className: j,
                            readonly: !0,
                            tabIndex: "-1",
                            value: O
                        })), (0, Q.createElement)("input", B({
                            "aria-expanded": x ? "true" : "false",
                            "aria-activedescendant": !!t && a + "__option--" + b,
                            ...
                            var n = (-1 === b ? k === t : b === t) && null === w ? " " + R + "--focused" : "",
                                r = t % 2 ? " " + R + "--odd" : "",
                                i = $() ? "<span id=" + a + "__option-suffix--" + t + ' style="border:0;clip:rect(0 0 0 0);height:1px;marginBottom:-1px;marginRight:-1px;overflow:hidden;padding:0;position:absolute;whiteSpace:nowrap;width:1px"> ' + (t + 1) + " of " + E.length + "</span>" : "";
                        ...
                        }), A && (0, Q.createElement)("li", {
                            className: R + " " + R + "--no-results"
                        }, d())), (0, Q.createElement)("span", {
                            id: r,
                            style: {
                                display: "none"
                            }
                    ...
                    function c(e) {
                        var t;
                        return (t = s.call(this, e) || this).elementReferences = {}, t.state = {
                            focused: null,
                            hovered: null,
                            menuOpen: !1,
                    ...
                    e.exports = function (t, e, n) {
                        ...
                        }) && (s(String.prototype, t, n), a(RegExp.prototype, r, 2 == e ? function (e, t) {
        ...
        $ = y(function (r, e) {
            ! function () {
                var t, c, l, e, d, f, p, h, m, y, g, v, b, w, x, E, S, k, T, _, O, L, C, j, A, n, R = function (e) {
                    var t = new R.Builder;
                    return t.pipeline.add(R.trimmer, R.stopWordFilter, R.stemmer), t.searchPipeline.add(R.stemmer), e.call(t, t), t.build()
                };
                R.version = "2.3.6", R.utils = {}, R.utils.warn = (t = this, function (e) {
                    ...
                    e = this._stack.indexOf(e); - 1 != e && this._stack.splice(e, 1)
                    ...
                    for (var t, n, r = 0, i = this.elements, o = e.elements, a = i.length, s = o.length, u = 0, c = 0; u < a && c < s;)(t = i[u]) < (n = o[c]) ? u += 2 : n < t ? c += 2 : t == n && (r += i[u + 1] * o[c + 1], u += 2, c += 2);
                    return r
                    ...
                    ful: "",
                    ness: ""
                }, n = "[aeiouy]", e = "[^aeiou][^aeiouy]*", d = new RegExp("^([^aeiou][^aeiouy]*)?[aeiouy][aeiou]*[^aeiou][^aeiouy]*"), f = new RegExp("^([^aeiou][^aeiouy]*)?[aeiouy][aeiou]*[^aeiou][^aeiouy]*[aeiouy][aeiou]*[^aeiou][^aeiouy]*"), p = new RegExp("^([^aeiou][^aeiouy]*)?[aeiouy][aeiou]*[^aeiou][^aeiouy]*([aeiouy][aeiou]*)?$"), h = new RegExp("^([^aeiou][^aeiouy]*)?[aeiouy]"), m = /^(.+?)(ss|i)es$/, y = /^(.+?)([^s])s$/, g = /^(.+?)eed$/, v = /^(.+?)(ed|ing)$/, b = /.$/, w = /(at|bl|iz)$/, x = new RegExp("([^aeiouylsz])\\1$"), E = new RegExp("^" + e + n + "[^aeiouwxy]$"), S = /^(.+?[^aeiou])y$/, k = /^(.+?)(ational|tional|enci|anci|izer|bli|alli|entli|eli|ousli|ization|ation|ator|alism|iveness|fulness|ousness|aliti|iviti|biliti|logi)$/, T = /^(.+?)(icate|ative|alize|iciti|ical|ful|ness)$/, _ = /^(.+?)(al|ance|ence|er|ic|able|ible|ant|ement|ment|ent|ou|ism|ate|iti|ous|ive|ize)$/, O = /^(.+?)(s|t)(ion)$/, L = /^(.+?)e$/, C = /ll$/, j = new RegExp("^" + e + n + "[^aeiouwxy]$"), A = function A(e) {
                    var t, n, r, i, o, a, s, u;
                    return e.length < 3 ? e : ("y" == (n = e.substr(0, 1)) && (e = n.toUpperCase() + e.substr(1)), s = y, (o = m).test(e) ? e = e.replace(o, "$1$2") : s.test(e) && (e = e.replace(s, "$1$2")), s = v, (o = g).test(e) ? (u = o.exec(e), (o = d).test(u[1]) && (e = e.replace(o = b, ""))) : s.test(e) && (a = (u = s.exec(e))[1], (s = h).test(a) && (r = x, i = E, (s = w).test(e = a) ? e += "e" : r.test(e) ? e = e.replace(o = b, "") : i.test(e) && (e += "e"))), (o = S).test(e) && (e = (a = (u = o.exec(e))[1]) + "i"), (o = k).test(e) && (a = (u = o.exec(e))[1], t = u[2], (o = d).test(a) && (e = a + c[t])), (o = T).test(e) && (a = (u = o.exec(e))[1], t = u[2], (o = d).test(a) && (e = a + l[t])), s = O, (o = _).test(e) ? (a = (u = o.exec(e))[1], (o = f).test(a) && (e = a)) : s.test(e) && (a = (u = s.exec(e))[1] + u[2], (s = f).test(a) && (e = a)), (o = L).test(e) && (a = (u = o.exec(e))[1], s = p, r = j, ((o = f).test(a) || s.test(a) && !r.test(a)) && (e = a)), s = f, (o = C).test(e) && s.test(e) && (e = e.replace(o = b, "")), "y" == n ? n.toLowerCase() + e.substr(1) : e)
                }, function (e) {
                    return e.update(A)
                    ...
                    for (var n = new R.TokenSet, r = [{
                        ...
                        var i, o, a, s, u, c, l = r.pop();
                        0 < l.str.length && ((u = l.str.charAt(0)) in l.node.edges ? i = l.node.edges[u] : (i = new R.TokenSet, l.node.edges[u] = i), 1 == l.str.length && (i["final"] = !0), r.push({
                            node: i,
                            editsRemaining: l.editsRemaining,
                            str: l.str.slice(1)
                        })), 0 != l.editsRemaining && ("*" in l.node.edges ? o = l.node.edges["*"] : (o = new R.TokenSet, l.node.edges["*"] = o), 0 == l.str.length && (o["final"] = !0), r.push({
                            node: o,
                            editsRemaining: l.editsRemaining - 1,
                            str: l.str
                        }), 1 < l.str.length && r.push({
                            node: l.node,
                            editsRemaining: l.editsRemaining - 1,
                            str: l.str.slice(1)
                        }), 1 == l.str.length && (l.node["final"] = !0), 1 <= l.str.length && ("*" in l.node.edges ? a = l.node.edges["*"] : (a = new R.TokenSet, l.node.edges["*"] = a), 1 == l.str.length && (a["final"] = !0), r.push({
                            node: a,
                            editsRemaining: l.editsRemaining - 1,
                            str: l.str.slice(1)
                        })), 1 < l.str.length && (s = l.str.charAt(0), (u = l.str.charAt(1)) in l.node.edges ? c = l.node.edges[u] : (c = new R.TokenSet, l.node.edges[u] = c), 1 == l.str.length && (c["final"] = !0), r.push({
                            node: c,
                            editsRemaining: l.editsRemaining - 1,
                            str: s + l.str.slice(2)
                        })))
                    ...
                    for (var t = new R.TokenSet, n = undefined, r = [{
                            qNode: e,
                            output: t,
                            node: this
                        }]; r.length;)
                        for (var n = r.pop(), i = Object.keys(n.qNode.edges), o = i.length, a = Object.keys(n.node.edges), s = a.length, u = 0; u < o; u++)
                            for (var c = i[u], l = 0; l < s; l++) {
                                var d, f, p, h, m = a[l];
                                m != c && "*" != c || (d = n.node.edges[m], f = n.qNode.edges[c], p = d["final"] && f["final"], h = undefined, m in n.output.edges ? (h = n.output.edges[m])["final"] = h["final"] || p : ((h = new R.TokenSet)["final"] = p, n.output.edges[m] = h), r.push({
                                    qNode: f,
                                    output: h,
                                    node: d
                                }))
                    ...
                    for (s = 0; s < t.clauses.length; s++) {
                        for (var u = t.clauses[s], c = null, l = R.Set.complete, c = u.usePipeline ? this.pipeline.runString(u.term, {
                                fields: u.fields
                            }) : [u.term], d = 0; d < c.length; d++) {
                            var f = c[d];
                            u.term = f;
                            ...
                            for (var m = 0; m < p.length; m++)
                                for (var y = p[m], g = this.invertedIndex[y], v = g._index, h = 0; h < u.fields.length; h++) {
                                    ...
                                    if (u.presence == R.Query.presence.REQUIRED && (l = l.union(E), o[O] === undefined && (o[O] = R.Set.complete)), u.presence != R.Query.presence.PROHIBITED) {
                                        if (r[O].upsert(v, u.boost, function (e, t) {
                                                return e + t
                                            }), !i[x]) {
                        ...
                        if (u.presence === R.Query.presence.REQUIRED)
                            for (h = 0; h < u.fields.length; h++) o[O = u.fields[h]] = o[O].intersect(l)
                    }
                    ...
                    for (s = 0; s < j.length; s++) {
                        var P, M, F = (N = R.FieldRef.fromString(j[s])).docRef;
                        L.contains(F) && (C.contains(F) || (P = this.fieldVectors[N], M = r[N.fieldName].similarity(P), (P = I[F]) !== undefined ? (P.score += M, P.matchData.combine(n[N])) : (M = {
                            ref: F,
                            score: M,
                            matchData: n[N]
                        }, I[F] = M, A.push(M))))
                    ...
                    for (var e = {}, t = Object.keys(this.fieldTermFrequencies), n = t.length, r = Object.create(null), i = 0; i < n; i++) {
                        for (var o = R.FieldRef.fromString(t[i]), a = o.fieldName, s = this.fieldLengths[o], u = new R.Vector, c = this.fieldTermFrequencies[o], l = Object.keys(c), d = l.length, f = this._fields[a].boost || 1, p = this._documents[o.docRef].boost || 1, h = 0; h < d; h++) {
                            var m, y = l[h],
                                g = c[y],
                                v = this.invertedIndex[y]._index;
                            r[y] === undefined ? (m = R.idf(this.invertedIndex[y], this.documentCount), r[y] = m) : m = r[y], g = m * ((this._k1 + 1) * g) / (this._k1 * (1 - this._b + this._b * (s / this.averageFieldLength[a])) + g), g *= f, g *= p, g = Math.round(1e3 * g) / 1e3, u.insert(v, g)
                        }
                        e[o] = u
                    }
                    this.fieldVectors = e
    ...
    function z(e) {
        return e = (e = (e = (e = e.replace(/[^\s=/?&]+(?:@|%40)[^\s=/?&]+/g, "[REDACTED EMAIL]")).replace(/\b[A-PR-UWYZ][A-HJ-Z]?[0-9][0-9A-HJKMNPR-Y]?(?:[\s+]|%20)*[0-9](?!refund)[ABD-HJLNPQ-Z]{2,3}\b/gi, "[REDACTED POSTCODE]")).replace(/^\s*[a-zA-Z]{2}(?:\s*\d\s*){6}[a-zA-Z]?\s*$/g, "[REDACTED NI NUMBER]")).replace(/[0-9]+/g, "[REDACTED NUMBER]")
    }
    var H = null,
        V = null,
        W = null,
    ...
    Y.prototype.fetchSearchIndex = function (e, t) {
        ...
        n.open("GET", e, !0), n.timeout = 1e4, W = "Loading search index", n.onreadystatechange = function () {
            var e;
        ...
        U = e, G = t, clearTimeout(K), K = setTimeout(function () {
            var e, t, n;
            e = U, t = J, window.DO_NOT_TRACK_ENABLED || (n = z(e), e = 0 < t.length, t = t.map(function (e, t) {
                return {
                    name: e.title,
                    category: e.section,
                    list: n,
        ...
        }, void 0 !== (t = window.__SITE_SEARCH_TRACKING_TIMEOUT) ? t : 2e3), this.renderResults()
    }, Y.prototype.handleOnConfirm = function (e) {
        var t, n, r, i, o = e.path;
        o && (t = U, n = J, r = e, window.DO_NOT_TRACK_ENABLED || (i = z(t), n = n.map(function (e, t) {
            return {
                name: e.title,
                category: e.section,
                list: i,
        ...
        if (e) {
            var t, n, r = document.createElement("span"),
                i = e.title;
            r.textContent = i, e.aliases && (t = e.aliases.split(",").map(function (e) {
                return e.trim()
            }), n = [], 0 < (n = -1 === i.toLowerCase().indexOf(U) ? t.filter(function (e) {
        ...
        var e = this.$module;
        e && "querySelector" in document && "addEventListener" in window && !(!Array.prototype || !Array.prototype.forEach) && (B({
            element: e,
            ...
            clearTimeout(K)
        }), e = e.getAttribute("data-search-index"), this.fetchSearchIndex(e, function () {
            this.renderResults()
        }.bind(this)))
    };
    var X = {
            ...
            expandMacroOptions: function () {
                var e, t, n, r, i, o, a, s = window.location.hash;
                s.match("^#options-") && (a = s.split("#options-")[1], (a = (e = -1 < s.indexOf("--")) ? a.split("--")[0] : a) && (n = (t = document.querySelector('a[href="#' + a + '-nunjucks"]')) ? t.parentNode : null, r = document.getElementById("options-" + a + "-details"), n && r && (i = r.parentNode, o = r.querySelector(".govuk-details__summary"), a = r.querySelector(".govuk-details__text"), o && a && (t.setAttribute("aria-expanded", !0), n.className += " app-tabs__item--current", i.classList.remove("app-tabs__container--hidden"), i.setAttribute("aria-hidden", !1), r.setAttribute("open", "open"), o.setAttribute("aria-expanded", !0), a.setAttribute("aria-hidden", !1), a.style.display = "", window.setTimeout(function () {
    ...
    ee.prototype.init = function () {
        this.$cookiePage = this.$module, this.$cookiePage && (this.$cookieForm = this.$cookiePage.querySelector(".js-cookies-page-form"), this.$cookieFormFieldsets = this.$cookieForm.querySelectorAll(".js-cookies-page-form-fieldset"), this.$successNotification = this.$cookiePage.querySelector(".js-cookies-page-success"), Z(this.$cookieFormFieldsets, function (e) {
            this.showUserPreference(e, c()), e.removeAttribute("hidden")
        }.bind(this)), this.$cookieForm.querySelector(".js-cookies-form-button").removeAttribute("hidden"), this.$cookieForm.addEventListener("submit", this.savePreferences.bind(this)))
    }, ee.prototype.savePreferences = function (e) {
        e.preventDefault();
        var n = {};
        Z(this.$cookieFormFieldsets, function (e) {
            var t = this.getCookieType(e),
                e = e.querySelector("input[name=" + t + "]:checked").value;
            n[t] = "yes" === e
        }.bind(this)), t(n), this.showSuccessNotification()
    ...
    g = c();
    g && l(g) && g.analytics && n(), te(document.querySelectorAll('[data-module="app-example-frame"]'), function (e) {
        new E(e).init()
    }), te(document.querySelectorAll('[data-module="app-tabs"]'), function (e) {
        new A(e).init()
    }), X.init(), te(document.querySelectorAll('[data-module="app-copy"]'), function (e) {
        new N(e).init()
    }), (new D).init(), new Y(document.querySelector('[data-module="app-search"]')).init(), new w(document.querySelector('[data-module="app-back-to-top"]')).init(), new ee(document.querySelector('[data-module="app-cookies-page"]')).init()
}();
